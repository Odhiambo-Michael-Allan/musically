...
class SettingsRepositoryImplTest {
    ...
    fun testSortArtistsInReverseIsCorrectlySet() = runTest {
        ...
        settingsRepository.setSortArtistsInReverseTo( true )
        assertTrue( preferenceStore.getSortArtistsInReverse() )
        assertTrue( settingsRepository.sortArtistsInReverse.value )
        settingsRepository.setSortArtistsInReverseTo( false )
        assertFalse( preferenceStore.getSortArtistsInReverse() )
        assertFalse( settingsRepository.sortArtistsInReverse.value )
    }
