...
object FileExplorer {
    ...
    fun sort(paths: List<String>, sortBy: SortPathBy, reverse: Boolean ): List<String> {
        val sorted = when( sortBy ) {
            SortPathBy.CUSTOM -> paths
            SortPathBy.NAME -> paths.sorted()
        }
